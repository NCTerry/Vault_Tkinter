...
class PassWord_Vault(Frame, Text, Scrollbar):
    ...
    def __init__(self, parent=None):
        ...
        # -----------
        menuLabel2x = Label(self, textvariable=menuLabel2, height=1)  # Create a label object
        menuLabel2x.config(font=("Cambria", 36, 'bold'))
        menuLabel2x.grid(row=2, column=0, columnspan=1, sticky=W)
        # -----------
        menuLabel3x = Label(self, textvariable=menuLabel3, height=1)  # Create a label object
        menuLabel3x.config(font=("Cambria", 36, 'bold'))
        menuLabel3x.grid(row=2, column=1, columnspan=1, sticky=W)
        # -----------
        ...
        userIDVAR = StringVar()
        idRulesVAR = StringVar()
        locationVAR = StringVar()
        locationExVAR = StringVar()
        usernameVAR = StringVar()
        passwordVAR = StringVar()
        passwordRULESVAR = StringVar()
        deleteVAR = StringVar()
        # -----------------------
        ...
        userIDVARx = Label(self, textvariable=userIDVAR, height=1)  # Create a label object
        userIDVARx.config(font=("Cambria", 18))
        userIDVARx.grid(row=11, column=0, columnspan=1, sticky=W)
        # =========
        idRulesVARx = Label(self, textvariable=idRulesVAR, height=1)  # Create a label object
        idRulesVARx.config(font=("Cambria", 10))
        idRulesVARx.grid(row=12, column=0, columnspan=1, sticky=W)
        # =========
        locationVARx = Label(self, textvariable=locationVAR, height=1)  # Create a label object
        locationVARx.config(font=("Cambria", 18))
        locationVARx.grid(row=13, column=0, columnspan=1, sticky=W)
        # =========
        locationExVARx = Label(self, textvariable=locationExVAR, height=1)  # Create a label object
        locationExVARx.config(font=("Cambria", 10))
        locationExVARx.grid(row=14, column=0, columnspan=1, sticky=W)
        # =========
        usernameVARx = Label(self, textvariable=usernameVAR, height=1)  # Create a label object
        usernameVARx.config(font=("Cambria", 18))
        usernameVARx.grid(row=15, column=0, columnspan=1, sticky=W)
        # =========
        passwordVARx = Label(self, textvariable=passwordVAR, height=1)  # Create a label object
        passwordVARx.config(font=("Cambria", 18))
        passwordVARx.grid(row=16, column=0, columnspan=1, sticky=W)
        # =========
        passwordRULESVARx = Label(self, textvariable=passwordRULESVAR, height=1)  # Create a label object
        passwordRULESVARx.config(font=("Cambria", 10))
        passwordRULESVARx.grid(row=17, column=0, columnspan=1, sticky=W)
        # =========
        deleteVARx = Label(self, textvariable=deleteVAR, height=1)  # Create a label object
        deleteVARx.config(font=("Cambria", 18))
        deleteVARx.grid(row=24, column=0, columnspan=1, sticky=W)
        # =========
        # ===========================================================================
        # Variables to hold the user input for the main menu.
        # ID  # , Location, UserName, Password
        self.userIDVAR_input = StringVar(None)
        self.userIDVAR_input.set('0')
        self.locationVAR_input = StringVar(None)
        self.usernameVAR_input = StringVar(None)
        self.passwordVAR_input = StringVar(None)
        self.deleteVar_input = StringVar(None)
        # ===========================================================================
        # ------------------------
        # 4 Entry boxes for the ID#, Location, UserName, Password
        self.userIDVAR_inputx = Entry(self, textvariable=self.userIDVAR_input, width=40)
        self.userIDVAR_inputx.grid(row=11, column=1, sticky=W)
        ...
        # ------------------------
        self.locationVAR_inputx = Entry(self, textvariable=self.locationVAR_input, width=40)
        self.locationVAR_inputx.grid(row=13, column=1, sticky=W)
        # ------------------------
        self.usernameVAR_inputx = Entry(self, textvariable=self.usernameVAR_input, width=40)
        self.usernameVAR_inputx.grid(row=15, column=1, sticky=W)
        # ------------------------
        self.passwordVAR_inputx = Entry(self, textvariable=self.passwordVAR_input, width=40)
        self.passwordVAR_inputx.grid(row=16, column=1, sticky=W)
        # ------------------------
        self.deleteVar_inputx = Entry(self, textvariable=self.deleteVar_input, width=20)
        self.deleteVar_inputx.grid(row=25, column=0, sticky=W)
        # ====================================================================================
        # 3 Primary Buttons

        button1 = Button(self, text="Encrypt Information", width=15, command=lambda: self.openFiles("Encrypt"))
        button1.grid(column=1, sticky=W, padx=15, pady=5)
        # --------
        button2 = Button(self, text="Decrypt Password List", width=15, command=lambda: self.openFiles("Decrypt"))
        button2.grid(column=1, sticky=W, padx=15, pady=5)
        # --------
        button3 = Button(self, text="View Encrypted List", width=15, command=lambda: self.openFiles("View"))
        button3.grid(column=1, sticky=W, padx=15, pady=5)
        # --------
        button4 = Button(self, text="Delete Password", width=15, command=lambda: self.openFiles("Delete"))
        button4.grid(row=26, column=0, sticky=W, padx=15, pady=5)
        # --------
        # ====================================================================================
...
# ============================================================================
    ...
    def decrypt_in_Main(self):
        ...
        for x in range(len(final_list)):
            ...
            self.text_widget.insert(END, str(x+1) + '[ User ID# ]\t' + final_list[4*x] + '\n')

            print x+1,  '[ Location ]\t' + final_list[4*x+1]
            finalString += (str(x+1) + '[ Location ]\t' + final_list[4*x+1] + '\n')
            self.text_widget.insert(END, str(x+1) + '[ Location ]\t' + final_list[4*x+1] + '\n')

            print x+1,  '[ Username ]\t' + final_list[4*x+2]
            finalString += (str(x+1) + '[ Username ]\t' + final_list[4*x+2] + '\n')
            self.text_widget.insert(END, str(x+1) + '[ Username ]\t' + final_list[4*x+2] + '\n')

            print x+1,  '[ Password ]\t' + final_list[4*x+3]
            finalString += (str(x+1) + '[ Password ]\t' + final_list[4*x+3] + '\n')
            self.text_widget.insert(END, str(x+1) + '[ Password ]\t' + final_list[4*x+3] + '\n')
            self.text_widget.insert(END, '--------------------------------------\n')
...
# =========================================================================
    def View_Encrypted_List(self):
        ...
        self.text_widget.insert(END, Full_Encrypted_List)
    # DECRYPTION SECTION
    # DECRYPTION SECTION
    # DECRYPTION SECTION
...
# =========================================================================
    ...
    def check_Password_Length(self, Local_Password):
        ...
        if (len(Local_Password) >= 6 and len(Local_Password) <= 30):
            ...
            self.passwordVAR_inputx.delete(0, END)
